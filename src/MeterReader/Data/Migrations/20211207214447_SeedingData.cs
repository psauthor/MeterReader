    ...
    public partial class SeedingData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2021, 12, 7, 16, 44, 47, 9, DateTimeKind.Local).AddTicks(6620), 1458.9000000000001 },
                    { 2, 1, new DateTime(2021, 12, 7, 16, 44, 47, 9, DateTimeKind.Local).AddTicks(6652), 18403.5 },
                    { 3, 2, new DateTime(2021, 12, 7, 16, 44, 47, 9, DateTimeKind.Local).AddTicks(6654), 0.0 },
                    { 4, 2, new DateTime(2021, 12, 7, 16, 44, 47, 9, DateTimeKind.Local).AddTicks(6655), 304.75 }
                });
